...
if __name__ == "__main__":
    ...
    print("EM:", em_refined(out, ref))
    print("BLEU-4:", bleu4_score(out, ref))
    print("ROUGE-L:", rouge_l_score(out, ref))
    print("CIDEr (no-IDF):", cider_score_0_100(out, ref))
    print("CIDEr_n:", cider_n(out, ref))
