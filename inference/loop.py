...
if __name__ == "__main__":
    MODEL_NAME = '../checkpoints/vqa_scanqa_images_multiturn_multi_choice/local_reward_1_pretrained_3/global_step_25/actor/huggingface'
    ...
    OUTPUT_DIR = 'results/local_reward_1_pretrained_3_global_step_25/'
    ...
    for idx, item in tqdm(enumerate(load_iterable_parquet())):
        '''
        item['extra_info'] = 
        {'answer': '["windows"]',
        'index': 0,
        ...
        final_assistant_text, rendered_text, messages, images = run_qwen_vl(
            ...
            model=model,
            processor=processor,
            high_resolution_images=item["image_paths"],
