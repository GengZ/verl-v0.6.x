...
from temporal_zoom_tool import run_temporal_zoom_tool_from_parsed_call
...
def init_qwen_vl_runtime(model_name: str = "Qwen/Qwen2.5-VL-3B-Instruct", device: str | None = None):
    ...
    # Install the custom chat template
...
if __name__ == "__main__":
    TOOL_CONFIG_PATH = '/home/geng/git/verl_0.6/recipe/scanqa_temporal_zoom_in/configs/temporal_zoom_tool_config.yaml'
    MAX_TURNS = 3
    ...
    OUTPUT_DIR = 'results/raw_qwen2_5_vl_7b_instruct_val_split_500/'
    ...
    print(f"Using first {MAX_ITEMS} items")

    for idx, item in tqdm(enumerate(parquet_data)):
        '''
        item['extra_info'] = 
        {'answer': '["windows"]',
        'index': 0,
        'question': 'What is above the radiator?',
        'question_id': 'train-scene0331-56',
        'split': 'train'}
        '''
